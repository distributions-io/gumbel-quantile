...
for `0 <= p < 1`, where `mu` is the location parameter and `beta` is the scale parameter.
...
[coveralls-image]: https://img.shields.io/coveralls/distributions-io/gumbel-quantile/master.svg
[coveralls-url]: https://coveralls.io/r/distributions-io/gumbel-quantile?branch=master
